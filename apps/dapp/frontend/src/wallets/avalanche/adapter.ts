...
// Placeholder API
class AvalancheChainAPI implements ChainAPI {
...
export class AvalancheWalletAdapter implements WalletAdapter {
    private api = new AvalancheChainAPI();
    async connect() { return null; }
    async disconnect() { }
    async getAccount() { return null; }
    getChainId() { return ChainId.AVALANCHE; }
