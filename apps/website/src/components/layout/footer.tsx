        ...
        <footer>
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <TabbedContainer 
                    ...
                    tabClassName="bg-[#000000] border-white/10"
                    contentClassName="bg-black border-white/10"
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
                        <div className="lg:col-span-2">
                            <Link href="/" className="flex items-center gap-2 font-bold text-2xl mb-6">
                                ...
                                <span className="text-white">Suinergy</span>
                            </Link>
                    ...
                    <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 mt-8">
